...
BOARD_PATH := device/xiaomi/gemini
...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x237 ehci-hcd.park=3 
lpm_levels.sleep_disabled=1 cma=32M@0-0xffffffff
...
# Recovery
TARGET_RECOVERY_FSTAB := $(BOARD_PATH)/rootdir/fstab.qcom
